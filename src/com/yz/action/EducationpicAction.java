...
@Component("educationpicAction")
@Scope("prototype")
public class EducationpicAction extends ActionSupport implements RequestAware,
	...
	private IEducationpicService educationpicService;
		...
		if (picture1 != null && picture1FileName != null
			...
			String imageName = DateTimeKit.getDateRandom()
					+ picture1FileName.substring(picture1FileName
							.indexOf("."));
			this.upload("/educationpic", imageName, picture1);
			educationpic.setPicDir("educationpic" + "/"
					+ imageName);
		}
		educationpicService.add(educationpic);
		return "success_child";
	}

	public String deleteEducationpic() throws Exception {

		educationpic = educationpicService.loadById(edid);

		if (educationpic.getPicDir() != null
				&& !educationpic.getPicDir().replace(" ", "").equals("")) {
			File photofile = new File(ServletActionContext.getServletContext()
					.getRealPath("/")
					+ educationpic.getPicDir());
			photofile.delete();
		}

		educationpicService.delete(educationpic);
	...
	public String update() {
		educationpicService.update(educationpic);
		return "success_child";
	}
	
	public String view() {
		educationpic = educationpicService.loadById(id);
		return "view";
	}
	...
	public IEducationpicService getEducationpicService() {
		return educationpicService;
	}

	@Resource
	public void setEducationpicService(IEducationpicService educationpicService) {
		this.educationpicService = educationpicService;
	}
