...
<html>
	...
	<body>
		<form action="useroAction!addUser" method="post"
			...
			<s:hidden name="graphicProgress" value="0"></s:hidden>
			<div class="xmWraper ">
				<div class="xmconbox pd-20">
					<div class="row cl Huialert-info box-shadow pd-5 bk-gray radius">
						...
						<a class="btn btn-success radius r mr-5 f-r"
							style="line-height: 1.6em; margin-top: 3px"
							href="javascript:childPage_close();" title="返回上一页"><i
						...
						<table id="gcgk" cellspacing="0" class="bk-gray radius box-shadow">
							<tbody>
								...
								<tr class="odd-row">
									...
									<td>
										<s:select list="#{0:'住宅',1:'公共建筑',2:'工业建筑'}" cssClass="select"
											name="project.buildingType" listKey="key" listValue="value"
								...
								<tr>
									...
									<td class="last">
										<span class="mini-textbox-border"><input placeholder=""
												value="基础/0%" class="mini-textbox-input" autocomplete="off"
												type="text"> </span>
									</td>
								</tr>
								<tr class="odd-row">
								...
								<tr>
									...
									<td class="last">
										<span class="mini-textbox-border"><s:textfield
												cssClass="mini-textbox-input" name="project.constructionPermitNumber" />
										</span>
									</td>
								</tr>
								<tr class="odd-row">
									...
									<td class="last">
										<span class="mini-textbox-border"><s:textfield
												cssClass="mini-textbox-input" name="project.sourcesOfInvestment" />
										</span>
									</td>
								</tr>
								<tr>
						...
						<table id="gcgk" cellspacing="0" class="bk-gray radius box-shadow"
							...
							<tbody>
								...
								<tr class="odd-row">
									...
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input" name="project.buildUnit" /> </span>
									</td>
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input"
								...
								<tr class="odd-row">
									...
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input" name="project.reconnaissanceUnit" /> </span>
									</td>
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input"
								...
								<tr>
									...
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input" name="project.designUnit" /> </span>
									</td>
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input"
								...
								<tr class="odd-row">
									...
									<td>
										<button type="submit" class="btn btn-success radius"
											id="button" name=""
											onClick="difficult_start('新增单位','add-company.html')">
											<i class="Hui-iconfont">&#xe600;</i>新增单位
										</button>
									</td>
									<td colspan="2">
										&nbsp;
								...
								<tr>
									...
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input" name="project.supervisionUnit" />
										</span>
									</td>
									<td>
										<span class="mini-textbox-border"> <s:textfield
								...
								<tr>
									...
									<td>
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input" name="project.constructionDrawingUnit" />
										</span>
									</td>
									<td>
										<span class="mini-textbox-border"> <s:textfield
									...
									<td class="last">
										<span class="mini-textbox-border"> <s:textfield
												cssClass="mini-textbox-input"
												name="project.constructionDrawingUnitPrincipalTelphone" /> </span>
									</td>
								</tr>
								<tr class="odd-row">
