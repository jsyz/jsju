...
<html>
	...
	<body>
		<form action="projectAction!update" method="post"
			...
			<s:hidden name="project.daymanage.isFiveSigned"></s:hidden>
			<s:hidden name="project.daymanage.signTime"></s:hidden>
			<s:hidden name="project.daymanage.isMassSafeNotify"></s:hidden>
			<s:hidden name="project.daymanage.notifyTime"></s:hidden>
			<s:hidden name="project.daymanage.isEducationLaunch"></s:hidden>
			<s:hidden name="project.daymanage.launchContent"></s:hidden>
			<s:hidden name="project.daymanage.isDangerArgument"></s:hidden>
			<s:hidden name="project.daymanage.isNameplateInstall"></s:hidden>
			<s:hidden name="project.daymanage.installTime"></s:hidden>
			<s:hidden name="project.daymanage.isMortarQualified"></s:hidden>
			<s:hidden name="project.daymanage.isCompleted"></s:hidden>
			<s:hidden name="project.daymanage.completedTime"></s:hidden>
			
			<s:hidden name="project.construction.id"></s:hidden>
			<s:hidden name="project.construction.isWashSet"></s:hidden>
			<s:hidden name="project.construction.washSetImg"></s:hidden>
			<s:hidden name="project.construction.isWaterClear"></s:hidden>
			<s:hidden name="project.construction.waterClearImg"></s:hidden>
			<s:hidden name="project.construction.isDoorConform"></s:hidden>
			<s:hidden name="project.construction.doorConformImg"></s:hidden>
			<s:hidden name="project.construction.isGuardConform"></s:hidden>
			<s:hidden name="project.construction.guardConformImg"></s:hidden>
			<s:hidden name="project.construction.isAdConform"></s:hidden>
			<s:hidden name="project.construction.adConformImg"></s:hidden>
			<s:hidden name="project.construction.isRoadHarden"></s:hidden>
			<s:hidden name="project.construction.roadHardenImg"></s:hidden>
			<s:hidden name="project.construction.isRoadClear"></s:hidden>
			<s:hidden name="project.construction.roadClearImg"></s:hidden>
			<s:hidden name="project.construction.isLabelComplete"></s:hidden>
			<s:hidden name="project.construction.labelCompleteImg"></s:hidden>
			<s:hidden name="project.construction.isLayoutRational"></s:hidden>
			<s:hidden name="project.construction.layoutRationalImg"></s:hidden>
			<s:hidden name="project.construction.isMeetFire"></s:hidden>
			<s:hidden name="project.construction.meetFireImg"></s:hidden>
			<s:hidden name="project.construction.isMeasurePlace"></s:hidden>
			<s:hidden name="project.construction.measurePlaceImg"></s:hidden>
			<div class="xmWraper ">
